const CheckoutOrder = () => {
  return (
    <div className="checkout-order-box w-full flex justify-center my-5 ">
      <div className="checkout-order w-[650px] h-full overflow-hidden bg-white  ">
        <div className="py-3 px-6 checkout-order-header">
          <h2 className="text-[20px] font-[500]">สรุปคำสั่งซื้อ</h2>
        </div>
        <div className="p-6 checkout-order-menu">
        ...
        <div className="checkout-order-sum-box flex flex-col p-6 w-full">
